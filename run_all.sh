julia --project stlcg-1.jl > out/stlcg-1.log
julia --project stlcg-2.jl > out/stlcg-2.log
julia --project doorpuzzle-1.jl > out/doorpuzzle-1.log
julia --project rover-2.jl > out/rover-2.log
